...
class C_NGG_Admin_Overview
{
    ...
    public function about_metabox()
    {
        ?>
        <div id="poststuff">
            <p><?php _e("NextGEN Gallery is one of the most popular WordPress plugins of all time with over 14 million downloads.", 'nggallery'); _e("It is developed and supported by Imagely. We'd like to offer a special thanks to Alex Rabe, who first developed the plugin and maintained it through 2011.", 'nggallery'); ?></p>
